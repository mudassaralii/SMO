            ...
            <div id="data_fresh" style="display:none;">
                <table class="table table-striped table-bordered tablesorter" style="margin-top: 7%;">
                    <tbody>
                        ...
                        <tr class="rowSAR">
                            ...
                            <td>
                                <div style="width: 50%; height: 50%; float:left; margin-left: -15px;">
                                    ...
                                    <span style="font-size: 20px; padding-left: 10px;">-</span>
                                    <input type="number" step="5" min="20" max="50" name="points" id="freshAngleUpper2" class="form-control input-sm input-slider input-slider-left ng-pristine ng-valid ng-valid-min ng-valid-max ng-touched step" value="50">
                                </div>
                                <div style="width: 50%; height: 50%; float:left;">
                        ...
                        <tr>
                            <td colspan="2">
                                <button type="button" id="displayUpcomingAttempts" data-toggle="button" aria-pressed="true" autocomplete="off" class="btn btn-primary" onclick="displayUpcomingAttempts(document.querySelector('#freshAngleUpper').value);" style="padding: 4px; min-width: 40px; background: white; border: 1px solid #0d5881; color: #0d5881;">
                                    Upcoming Attempts
