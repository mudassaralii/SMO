            ...
            <div id="data_fresh" style="display:none;">
                <table class="table table-striped table-bordered tablesorter" style="margin-top: 7%;">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2">
                                <button type="button" id="displayUpcomingAttempts" data-toggle="button" aria-pressed="true" class="btn btn-primary" onclick="displayUpcomingAttempts(document.querySelector('#freshAngleUpper').value);" style="padding: 4px; min-width: 40px; background: white; border: 1px solid #0d5881; color: #0d5881;">
                                    Upcoming Attempts
